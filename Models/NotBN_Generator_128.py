...
from Models.common import NotBN_Residual_block, Pixelsuffler_block

class NotBN_Generator(nn.Module):
    def __init__(self, channelsize = 128, scale_factor = 4, resblock_num = 16):
        super(NotBN_Generator, self).__init__()
        ...
        for i in range(resblock_num):
            resblock = NotBN_Residual_block(channel=channelsize)
